...
static inline zmem_common_pool_set_t *find_set(zmem_common_pool_t * worker, const void *ptr)
{
    zmem_common_pool_setgroup_t *setgroup_list, *setgroup;
...
static inline void free_by_set(zmem_common_pool_t * worker, zmem_common_pool_set_t * set, const void *ptr)
{
