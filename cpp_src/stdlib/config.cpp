...
ssize_t config::get_long(const char *key, ssize_t default_val)
{
    return zconfig_get_long(cf_, key, default_val);
}

ssize_t config::get_second(const char *key, ssize_t default_val)
{
    return zconfig_get_second(cf_, key, default_val);
}

ssize_t config::get_size(const char *key, ssize_t default_val)
{
