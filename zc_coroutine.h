...
#ifndef tmp_namespace_c_begin
#define tmp_namespace_c_begin \
   extern "C"                 \
   {
#define tmp_namespace_c_end }
#endif // tmp_namespace_c_begin

#ifdef __cplusplus
tmp_namespace_c_begin;
#endif
...
inline void zcoroutine_sleep(int seconds)
{
   zcoroutine_sleep_millisecond(seconds * 1000);
}
