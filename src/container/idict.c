...
zidict_node_t *zidict_add(zidict_t * mp, long key, char *value)
{
...
zidict_node_t *zidict_lookup(zidict_t * mp, long key, char **value)
{
    zidict_node_t mp_n, *mp_np;
    zrbtree_node_t *rb_np;
...
zidict_node_t *zidict_lookup_near_prev(zidict_t * mp, long key, char **value)
{
    zidict_node_t mp_n, *mp_np;
    zrbtree_node_t *rb_np;
...
zidict_node_t *zidict_lookup_near_next(zidict_t * mp, long key, char **value)
{
    zidict_node_t mp_n, *mp_np;
    zrbtree_node_t *rb_np;
...
void zidict_walk(zidict_t * mp, void (*walk_fn) (zidict_node_t *, void *), void *ctx)
{
    zidict_node_t *node;
